...
/*           --------------------------------------- ------- ----- */
REG_DEF(     board_id_pcb_rev,                       0x00,   8)
...
REG_DEF(     fan_pwm_1_reg,                          0x0E,   8)
REG_DEF(     fan_pwm_2_reg,                          0x0F,   8)
REG_DEF(     fan_pwm_3_reg,                          0x10,   8)
REG_DEF(     fan_pwm_4_reg,                          0x11,   8)
REG_DEF(     fan_pwm_5_reg,                          0x12,   8)
REG_DEF(     fan_pwm_6_reg,                          0x13,   8)
...
/*                      ----------------------      ----------------              ------ ----- */
FLD_RAW_RO_DEF(         board_id_pcb_rev,           board_id,                     0,      1)
FLD_RAW_RO_DEF(         board_id_pcb_rev,           pcb_rev,                      1,      2)
...
FLD_RAW_RW_DEF(         rst_ctrl_1,                 mgmt_88e6432_rst,             6,      1)
...
FLD_RAW_RW_DEF(         rst_ctrl_3,                 fm_cpld_ngff_rst,             0,      1)
...
FLD_RAW_RW_DEF(         imask_2,                    mgmt_88e6432_imask,           6,      1)
FLD_RAW_RW_DEF(         imask_2,                    i2c1_alert_imask,             7,      1)
...
FLD_RAW_RW_DEF(         status_led_reg,             locator_led,                  0,      2)
FLD_RAW_RW_DEF(         status_led_reg,             status_led,                   2,      2)
FLD_RAW_RW_DEF(         status_led_reg,             id_led,                       4,      2)

FLD_RAW_RW_DEF(         fan_led,                    fan_led_1,                    0,      1)
FLD_RAW_RW_DEF(         fan_led,                    fan_led_2,                    1,      1)
FLD_RAW_RW_DEF(         fan_led,                    fan_led_3,                    2,      1)
FLD_RAW_RW_DEF(         fan_led,                    fan_led_4,                    3,      1)
FLD_RAW_RW_DEF(         fan_led,                    fan_led_5,                    4,      1)
FLD_RAW_RW_DEF(         fan_led,                    fan_led_6,                    5,      1)
...
REG_DEF_SPEC(     fan_tach_1_1a,                          0x14)
REG_DEF_SPEC(     fan_tach_1_2a,                          0x16)
REG_DEF_SPEC(     fan_tach_2_1a,                          0x18)
REG_DEF_SPEC(     fan_tach_2_2a,                          0x1A)
REG_DEF_SPEC(     fan_tach_3_1a,                          0x1C)
REG_DEF_SPEC(     fan_tach_3_2a,                          0x1E)
REG_DEF_SPEC(     fan_tach_4_1a,                          0x20)
REG_DEF_SPEC(     fan_tach_4_2a,                          0x22)
REG_DEF_SPEC(     fan_tach_5_1a,                          0x24)
REG_DEF_SPEC(     fan_tach_5_2a,                          0x26)
REG_DEF_SPEC(     fan_tach_6_1a,                          0x28)
REG_DEF_SPEC(     fan_tach_6_2a,                          0x2A)
