...
#include "x86-64-wnc-rseb-w1-32-system_cpld_reg.h"
#include "x86-64-wnc-rseb-w1-32-system_cpld_sysfs.h"
...
static struct attribute *misc_attributes[] = {
    SYSFS_ATTR_PTR(board_id),                     /* register: board_id_pcb_rev */
    SYSFS_ATTR_PTR(pcb_rev),                      /* register: board_id_pcb_rev */
    ...
    SYSFS_ATTR_PTR(mgmt_88e6432_rst),             /* register: rst_ctrl_1 */
    ...
    SYSFS_ATTR_PTR(fm_cpld_ngff_rst),             /* register: rst_ctrl_3 */
    ...
    SYSFS_ATTR_PTR(mgmt_88e6432_imask),           /* register: imask_2 */
    SYSFS_ATTR_PTR(i2c1_alert_imask),             /* register: imask_2 */
    ...
    SYSFS_ATTR_PTR(locator_led),                  /* register: status_led_reg */
